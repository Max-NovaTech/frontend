...
const Login = () => {
  ...
  return (
    <div className="login-page min-h-screen bg-white text-surface-900 flex">
      <style>{`
        .login-page input:focus, .login-page textarea:focus, .login-page select:focus {
          outline: none;
          box-shadow: 0 0 0 3px rgba(13, 148, 128, 0.12) !important;
          border-color: #0d9480 !important;
        }
        .login-page .nova-gradient { background: linear-gradient(135deg, #0d9480 0%, #115e54 100%); }
      `}</style>
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden nova-gradient">
        <div className="absolute inset-0">
          <div className="absolute top-20 left-16 w-64 h-64 bg-nova-400/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-32 right-12 w-80 h-80 bg-amber-300/10 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/3 w-40 h-40 bg-nova-300/15 rounded-full blur-2xl"></div>
        </div>

        <div className="relative z-10 flex flex-col justify-between py-10 px-12 xl:px-16 w-full">
          <div className="flex items-center gap-2.5">
            <img src="/logo-icon.png" alt="NovaTech" className="w-10 h-10 rounded-xl" />
          ...
          >
            ...
            <p className="text-nova-100 text-base leading-relaxed mb-10">
              Fast, secure, and affordable connectivity solutions for everyone. Buy data for all major networks in one place.
            </p>
            
            <div className="space-y-4">
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 bg-white/12 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/10">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div>
                  <span className="text-white text-sm font-medium">Secure Transactions</span>
                  <p className="text-nova-200 text-xs">Industry-standard encryption</p>
                </div>
              </div>
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 bg-white/12 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-nova-200 text-xs">Data delivered in seconds</p>
                </div>
              </div>
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 bg-white/12 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-nova-200 text-xs">MTN, Telecel, AirtelTigo</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex items-center gap-8">
            <div>
              ...
              <div className="text-nova-200 text-xs">Customers</div>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div>
              <div className="text-2xl font-bold text-white">99.9%</div>
              <div className="text-nova-200 text-xs">Uptime</div>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div>
              <div className="text-2xl font-bold text-white">24/7</div>
              <div className="text-nova-200 text-xs">Support</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-8 sm:py-12 bg-gradient-to-b from-surface-50 to-white lg:from-white lg:to-white">
        <motion.div
        ...
        >
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1 bg-nova-50 rounded-full">
              <span className="w-1.5 h-1.5 rounded-full bg-nova-500"></span>
              <span className="text-nova-700 text-xs font-medium">Secure Login</span>
            </div>
          </div>

          <div className="mb-7">
            <h2 className="text-2xl font-bold text-surface-900 mb-1.5">Welcome back</h2>
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-5 p-3.5 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm flex items-center gap-2"
            >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white border border-surface-200 rounded-xl text-surface-900 placeholder-surface-400 transition-all text-sm"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-3 bg-white border border-surface-200 rounded-xl text-surface-900 placeholder-surface-400 transition-all text-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 nova-gradient text-white text-sm font-semibold rounded-xl transition-all hover:opacity-90 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-nova-600/20"
            >
              {loading ? (
            ...
            <div className="text-center pt-1">
              <a
                ...
                className="inline-flex items-center gap-1.5 text-sm text-nova-600 hover:text-nova-700 transition-colors font-medium"
              >
            ...
            <div className="flex flex-wrap justify-center gap-3 text-xs text-surface-400 pt-4 border-t border-surface-100">
              <button type="button" onClick={() => setShowTermsModal(true)} className="hover:text-nova-600 transition-colors">
                Terms & Conditions
              </button>
              <span className="text-surface-200">|</span>
              <button type="button" onClick={() => setShowPrivacyModal(true)} className="hover:text-nova-600 transition-colors">
                Privacy Policy
              </button>
              <span className="text-surface-200">|</span>
              <button type="button" onClick={() => setShowRefundModal(true)} className="hover:text-nova-600 transition-colors">
                Refund Policy
              </button>
              <span className="text-surface-200">|</span>
              <button type="button" onClick={() => setShowFaqModal(true)} className="hover:text-nova-600 transition-colors">
                FAQs
              </button>
            </div>
          </form>
          ...
          <div className="text-center mt-6">
            <a href="/" className="text-surface-400 hover:text-surface-600 transition-colors text-sm inline-flex items-center gap-1.5">
          ...
          <Dialog.Panel className="bg-white p-6 rounded-xl shadow-2xl max-w-2xl w-full mx-4 overflow-y-auto max-h-[90vh]">
            ...
            <div className="space-y-6 text-sm text-gray-700">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Website: <a href="https://NovaTech.vercel.app/" className="text-blue-500 underline">https://novamaxgh.vercel.app/</a></li>
          ...
          <Dialog.Panel className="bg-white p-6 rounded-xl shadow-2xl max-w-2xl w-full mx-4 overflow-y-auto max-h-[90vh]">
            ...
            <div className="space-y-6 text-sm text-gray-700">
              <section>
                ...
                <p>At NovaTech, we strive to provide reliable and efficient data bundle services. We understand that issues may occasionally arise, and we are committed to resolving them fairly. This Refund Policy outlines the conditions under which refunds may be granted.</p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li><strong>Contact:</strong> Submit your request via WhatsApp at <span className="text-blue-600">0544060817</span> or email <a href="mailto:kelisdata22@gmail.com" className="text-blue-500 underline">kelisdata22@gmail.com</a>.</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li><strong>Account Credit:</strong> Refunds are typically credited to your NovaTech account balance for future purchases.</li>
              ...
              <section>
                ...
                <p>NovaTech reserves the right to modify this Refund Policy at any time. Changes will be posted on this page with an updated effective date.</p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Email: <a href="mailto:kelisdata22@gmail.com" className="text-blue-500 underline">novamaxgh@gmail.com</a></li>
                  <li>WhatsApp: <span className="text-blue-600">0544060817</span></li>
                </ul>
              </section>
            </div>
      ...
      <Dialog open={showFaqModal} onClose={() => setShowFaqModal(false)}>
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <Dialog.Panel className="bg-white p-6 rounded-xl shadow-2xl max-w-2xl w-full mx-4 overflow-y-auto max-h-[90vh]">
            ...
            <div className="space-y-6 text-sm text-gray-700">
              <section>
                <h3 className="font-semibold text-lg text-gray-800 mb-2">1. What is NovaTech?</h3>
                <p>NovaTech is a trusted online platform for purchasing affordable data bundles for MTN, AirtelTigo, and Telecel networks in Ghana. We provide fast, reliable, and secure data bundle services.</p>
              </section>

              <section>
                <h3 className="font-semibold text-lg text-gray-800 mb-2">2. How do I purchase data bundles?</h3>
                <p>Simply log into your NovaTech account, select the data bundle you want, enter the recipient's phone number, and complete the payment. Your data will be delivered instantly.</p>
              </section>
              ...
              <section>
                ...
                <p>If you don't receive your data within 15 minutes, please contact our support team via WhatsApp at 0544060817 with your Order ID and payment confirmation.</p>
              </section>
              ...
              <section>
                ...
                <p>To create an account, contact our registration agent via WhatsApp at 0544060817. Account creation is by invitation to maintain service quality.</p>
              </section>
